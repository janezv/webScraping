...
<html>
   ...
   <div class="top-container">
    ...
    <div class="container">
        ...
        <h2>Prikaži zgodovino Snežne odeje</h2>
    ...
    <!-- glava tabele -->
        ...
        <tr><th><a href="/vreme/sneg.php?sort=Dan">Dan</a></th><th><a href="/vreme/sneg.php?sort=Kr">◊ Kredarica</a></th><th><a href="/vreme/sneg.php?sort=Zv">◊ Zavižan</a></th><th><a href="/vreme/sneg.php?sort=Lj">◊ Ljubljana</a></th></tr>
        </div>
...
// izberi razvrstitev
    if(($_SESSION['count']%2==0) && ($_GET['sort']=="Dan")){
        ...
        $queryDB->querySneg($histUSA, $nowUSA, $order);
    }
    ...
    elseif(($_SESSION['count']%2==0) && ($_GET['sort']=="Zv")){
        $order=" ORDER BY Zavizan DESC";
        $queryDB->querySneg($histUSA, $nowUSA, $order);        
    }
    elseif(($_SESSION['count']%2==1) && ($_GET['sort']=="Zv")){
        $order=" ORDER BY Zavizan ASC";
        $queryDB->querySneg($histUSA, $nowUSA, $order);        
    }
